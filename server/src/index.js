...
const dataEditorRoutes = require('./routes/dataEditor.routes');
const fimEditorRoutes = require('./routes/fimEditor.routes');
const calibrationRoutes = require('./routes/calibration.routes');
const machineryRoutes = require('./routes/machinery.routes');
const machineAllocationRoutes = require('./routes/machineAllocation.routes');
...
app.use('/api/data-editor', dataEditorRoutes);
app.use('/api/fim-editor', fimEditorRoutes);
